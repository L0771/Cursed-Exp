...
data.raw["gui-style"]["default"]["cursed-frame-compass"] = 
	...
	graphical_set =
		...
		monolith_image =
			{
			filename = "__Cursed-Exp__/gui/compass.png",
			width = 200,
			height = 200,
			x = 0,
			y = 0
...
data.raw["gui-style"]["default"]["cursed-button"] = 
	...
	-- default_font_color={r=0.4, g=0, b=0.8},
	align = "center",
	top_padding = 0,
	right_padding = 0,
	bottom_padding = 0,
	...
	-- disabled_graphical_set =
		...
		-- position = {0, 0}
		-- },
	-- pie_progress_color = {r=0, g=0, b=0}
    }
...
data.raw["gui-style"]["default"]["cursed-button-point"] = 
	...
	default_graphical_set =
		...
		monolith_image =
			{
			filename = "__Cursed-Exp__/gui/point.png",
			width = 7,
			height = 7,
			x = 0,
			y = 0
...
data.raw["gui-style"]["default"]["cursed-buttonMini2"] = 
	...
	default_graphical_set =
		...
		monolith_image =
			{
			filename = "__Cursed-Exp__/gui/close.png",
			width = 30,
			height = 31,
			x = 0,
			y = 0
...
data.raw["gui-style"]["default"]["cursed-buttonClosed"] = 
	...
	default_graphical_set =
		...
		monolith_image =
			{
			filename = "__Cursed-Exp__/gui/open.png",
			width = 43,
			height = 49,
			x = 0,
			y = 0
